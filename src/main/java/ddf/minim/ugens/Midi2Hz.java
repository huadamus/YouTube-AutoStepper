...
/**
 * Midi2Hz is a UGen that will autostepper.convert a MIDI note number to a frequency in
...
public class Midi2Hz extends UGen 
{
	 ...
	 *            float: the MIDI note to autostepper.convert to Hz (values in the range [0,127])
	 */
